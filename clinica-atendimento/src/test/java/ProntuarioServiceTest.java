...
class ProntuarioServiceTest {
    ...
    void testGetProntuarioById() {
        ...
        ProntuarioDto result = prontuarioService.getProntuarioById(1L);
    ...
    void testUpdateProntuario() {
        ...
        ProntuarioDto result = prontuarioService.updateProntuario(1L, request);
    ...
    void testDeleteProntuario() {
        ...
        prontuarioService.deleteProntuario(1L);
